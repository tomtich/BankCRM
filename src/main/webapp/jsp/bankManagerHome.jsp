...
<script type="text/javascript">
	...
	function addOneCustomer(srow, index) {
		console.log(srow);
		contents = contents
				+ '<div id = "mydiv'+ srow.cid + '"><h4 style = "color:#4000ff;">Request #'
				+ srow.cid
				+ '<a href="javascript:showTable('
				+ srow.cid
				+ ')"><button type="button" class="btn btn-primary">Show</button><a href="javascript:hideTable('
				+ srow.cid
				+ ')"><button type="button" class="btn btn-primary">Hide</button> </h4><br><br><table class="table" style="width: 80%; display:none;"  id="table'
				+ srow.cid + '">';
